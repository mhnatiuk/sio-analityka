...
left outer join 
		szkoly11
		as j11 on (j10.jedn_identyfikator=j11.jedn_identyfikator or ( (j07.teryt7cyfr=j08.teryt7cyfr) and (j10.jedn_kodpoczt=j11.jedn_kodpoczt) and (j10.jedn_telefon=j11.jedn_telefon) ) or (j10.liczba_wystapien_miejscowosci=1 and j11.liczba_wystapien_miejscowosci=1 and j10.miejscowosc=j11.miejscowosc) )
--where 
