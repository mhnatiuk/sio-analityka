...
select j.*,u.jedn_kodpoczt,substring(u.jedn_telefon from '[0-9]{7}$')::numeric as jedn_telefon, u.jedn_nazwa, u.jedn_ulica,u.jedn_domlokal,
m.miejscow_nazwa as miejscowosc, jedn_www , l_uczniow,g.gmina_nazwa, (g.wojew_idgus || g.powiat_idgus || g.gmina_idgus || g.gminatyp_id  ) as teryt7cyfr
	from sio2007.jedn j
		left join sio2007.jedn_uzup u on (j.jedn_id=u.jedn_id)
		left join (select jedn_id,sum(jednnaboddzkl_brokucz) AS l_uczniow
					FROM
...
u.jedn_ulica,u.jedn_domlokal,m.miejscow_nazwa as miejscowosc, jedn_www ,l_uczniow,
...
select j.*,u.jedn_kodpoczt,substring(u.jedn_telefon from '[0-9]{7}$')::numeric as jedn_telefon, u.jedn_nazwa, u.jedn_ulica,u.jedn_domlokal,
m.miejscow_nazwa as miejscowosc, jedn_www, l_uczniow,
	g.gmina_nazwa, (g.wojew_idgus || g.powiat_idgus || g.gmina_idgus || g.gminatyp_id  ) as teryt7cyfr
	from sio2010.jedn j 
...
select j.*,u.jedn_kodpoczt,substring(u.jedn_telefon from '[0-9]{7}$')::numeric as jedn_telefon, u.jedn_nazwa, u.jedn_ulica,u.jedn_domlokal,m.miejscow_nazwa as miejscowosc, jedn_www, l_uczniow,
g.gmina_nazwa, (g.wojew_idgus || g.powiat_idgus || g.gmina_idgus || g.gminatyp_id  ) as teryt7cyfr
	from sio2011.jedn j 
...
j07.l_uczniow as "lba_uczniow_07",
j08.l_uczniow as "lba_uczniow_08",
j09.l_uczniow as "lba_uczniow_09",
j10.l_uczniow as "lba_uczniow_10",
j11.l_uczniow as "lba_uczniow_11",
...
left outer join 
		szkoly08
		 as j08 on (j07.jedn_identyfikator=j08.jedn_identyfikator or ( (j07.teryt7cyfr=j08.teryt7cyfr) and (j07.jedn_kodpoczt=j08.jedn_kodpoczt) and (j07.jedn_telefon=j08.jedn_telefon) ) or (j07.liczba_wystapien_miejscowosci=1 and j08.liczba_wystapien_miejscowosci=1 and j07.miejscowosc=j08.miejscowosc) )
		
left outer join
		szkoly09
		as j09 on (j08.jedn_identyfikator=j09.jedn_identyfikator or ( (j07.teryt7cyfr=j08.teryt7cyfr) and (j08.jedn_kodpoczt=j09.jedn_kodpoczt) and (j08.jedn_telefon=j09.jedn_telefon) ) or (j08.liczba_wystapien_miejscowosci=1 and j09.liczba_wystapien_miejscowosci=1 and j08.miejscowosc=j09.miejscowosc) )
left outer join 
		szkoly10
		as j10 on (j09.jedn_identyfikator=j10.jedn_identyfikator or ( (j07.teryt7cyfr=j08.teryt7cyfr) and (j09.jedn_kodpoczt=j10.jedn_kodpoczt) and (j09.jedn_telefon=j10.jedn_telefon) ) or (j09.liczba_wystapien_miejscowosci=1 and j10.liczba_wystapien_miejscowosci=1 and j09.miejscowosc=j10.miejscowosc) )
left outer join 
		szkoly11
		as j11 on (j10.jedn_identyfikator=j11.jedn_identyfikator or ( (j10.teryt7cyfr=j11.teryt7cyfr) and (j10.jedn_kodpoczt=j11.jedn_kodpoczt) and (j10.jedn_telefon=j11.jedn_telefon) ) or (j10.liczba_wystapien_miejscowosci=1 and j11.liczba_wystapien_miejscowosci=1 and j10.miejscowosc=j11.miejscowosc) )
--where 
