...
left outer join 
		szkoly10
		 as j10 on (j11.jedn_identyfikator=j10.jedn_identyfikator or ( (j11.teryt7cyfr=j10.teryt7cyfr) and (j11.jedn_kodpoczt=j10.jedn_kodpoczt) and (j11.jedn_telefon=j10.jedn_telefon) ) or (j11.liczba_wystapien_miejscowosci=1 and j10.liczba_wystapien_miejscowosci=1 and j11.miejscowosc=j10.miejscowosc) )
		
left outer join
		szkoly09
		as j09 on (j10.jedn_identyfikator=j09.jedn_identyfikator or ( (j10.teryt7cyfr=j09.teryt7cyfr) and (j10.jedn_kodpoczt=j09.jedn_kodpoczt) and (j10.jedn_telefon=j09.jedn_telefon) ) or (j10.liczba_wystapien_miejscowosci=1 and j09.liczba_wystapien_miejscowosci=1 and j10.miejscowosc=j09.miejscowosc) )
left outer join 
		szkoly08
		as j08 on (j08.jedn_identyfikator=j09.jedn_identyfikator or ( (j08.teryt7cyfr=j09.teryt7cyfr) and (j08.jedn_kodpoczt=j09.jedn_kodpoczt) and (j08.jedn_telefon=j09.jedn_telefon) ) or (j08.liczba_wystapien_miejscowosci=1 and j09.liczba_wystapien_miejscowosci=1 and j08.miejscowosc=j09.miejscowosc) )
left outer join 
		szkoly07
		as j07 on (j07.jedn_identyfikator=j08.jedn_identyfikator or ( (j07.teryt7cyfr=j08.teryt7cyfr) and (j07.jedn_kodpoczt=j08.jedn_kodpoczt) and (j07.jedn_telefon=j08.jedn_telefon) ) or (j07.liczba_wystapien_miejscowosci=1 and j08.liczba_wystapien_miejscowosci=1 and j07.miejscowosc=j08.miejscowosc) )
