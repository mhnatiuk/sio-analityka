...
left outer join 
		szkoly08
		 as j08 on (j07.jedn_identyfikator=j08.jedn_identyfikator or ( (j07.teryt7cyfr=j08.teryt7cyfr) and (j07.jedn_kodpoczt=j08.jedn_kodpoczt) and (j07.jedn_telefon=j08.jedn_telefon) ) )
		
left outer join 
		szkoly09
		as j09 on (j08.jedn_identyfikator=j09.jedn_identyfikator or ( (j08.teryt7cyfr=j09.teryt7cyfr) and (j08.jedn_kodpoczt=j09.jedn_kodpoczt) and (j08.jedn_telefon=j09.jedn_telefon) ) )
left outer join 
		szkoly10
		as j10 on (j09.jedn_identyfikator=j10.jedn_identyfikator or ( (j09.teryt7cyfr=j10.teryt7cyfr) and (j09.jedn_kodpoczt=j10.jedn_kodpoczt) and (j09.jedn_telefon=j10.jedn_telefon) ) )
left outer join 
		szkoly11
		as j11 on (j10.jedn_identyfikator=j11.jedn_identyfikator or ( (j10.teryt7cyfr=j11.teryt7cyfr) and (j10.jedn_kodpoczt=j11.jedn_kodpoczt) and (j10.jedn_telefon=j11.jedn_telefon) ) )
--where 
