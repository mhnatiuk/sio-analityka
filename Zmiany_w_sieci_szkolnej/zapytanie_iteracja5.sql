...
select j.*,(case when (j.jedn_id != j.jednnadrz_id and j.jedn_id != j.jednmacierz_id ) then (j.jedn_identyfikator || 'FIL') else (jedn_identyfikator||'NIE') end) as jedn_identyfikator_filia,u.jedn_kodpoczt,substring(u.jedn_telefon from '[0-9]{7}$')::numeric as jedn_telefon, u.jedn_nazwa,
...
select j.*,(case when (j.jedn_id != j.jednnadrz_id and j.jedn_id != j.jednmacierz_id ) then (j.jedn_identyfikator || 'FIL') else (jedn_identyfikator||'NIE') end) as jedn_identyfikator_filia,u.jedn_kodpoczt,substring(u.jedn_telefon from '[0-9]{7}$')::numeric as jedn_telefon,
...
--create temp table szkoly12 as
--select szkoly12_h1.*, szkoly12_h2.liczba_wystapien_miejscowosci from szkoly12_h1 left outer join szkoly12_h2 on (szkoly12_h1.miejscowosc = szkoly12_h2.miejscowosc)
...
left outer join 
		szkoly08
		 as j08 on (j07.jedn_identyfikator_filia=j08.jedn_identyfikator_filia or ( (j07.teryt7cyfr=j08.teryt7cyfr) and (j07.jedn_kodpoczt=j08.jedn_kodpoczt) and (j07.jedn_telefon=j08.jedn_telefon or j07.jedn_ulica=j08.jedn_ulica) ) or (j07.liczba_wystapien_miejscowosci=1 and j08.liczba_wystapien_miejscowosci=1 and j07.miejscowosc=j08.miejscowosc) )
		
left outer join
		szkoly09
		as j09 on (j08.jedn_identyfikator_filia=j09.jedn_identyfikator_filia or ( (j08.teryt7cyfr=j09.teryt7cyfr) and (j08.jedn_kodpoczt=j09.jedn_kodpoczt) and (j08.jedn_telefon=j09.jedn_telefon or j08.jedn_ulica=j09.jedn_ulica) ) or (j08.liczba_wystapien_miejscowosci=1 and j09.liczba_wystapien_miejscowosci=1 and j08.miejscowosc=j09.miejscowosc) )
left outer join 
		szkoly10
		as j10 on (j09.jedn_identyfikator_filia=j10.jedn_identyfikator_filia or ( (j09.teryt7cyfr=j10.teryt7cyfr) and (j09.jedn_kodpoczt=j10.jedn_kodpoczt) and (j09.jedn_telefon=j10.jedn_telefon or j09.jedn_ulica=j10.jedn_ulica) ) or (j09.liczba_wystapien_miejscowosci=1 and j10.liczba_wystapien_miejscowosci=1 and j09.miejscowosc=j10.miejscowosc) )
left outer join 
		szkoly11
		as j11 on (j10.jedn_identyfikator_filia=j11.jedn_identyfikator_filia or ( (j10.teryt7cyfr=j11.teryt7cyfr) and (j10.jedn_kodpoczt=j11.jedn_kodpoczt) and (j10.jedn_telefon=j11.jedn_telefon or j10.jedn_ulica=j11.jedn_ulica) ) or (j10.liczba_wystapien_miejscowosci=1 and j11.liczba_wystapien_miejscowosci=1 and j10.miejscowosc=j11.miejscowosc) )
left outer join 
		szkoly12
		as j12 on (j11.jedn_identyfikator_filia=j12.jedn_identyfikator_filia or ( (j11.teryt7cyfr=j12.teryt7cyfr) and (j11.jedn_kodpoczt=j12.jedn_kodpoczt) and (j11.jedn_telefon=j12.jedn_telefon or j11.jedn_ulica=j12.jedn_ulica) ) or (j11.liczba_wystapien_miejscowosci=1 and j12.liczba_wystapien_miejscowosci=1 and j11.miejscowosc=j12.miejscowosc) )
